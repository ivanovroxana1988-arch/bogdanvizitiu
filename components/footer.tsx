  ...
  return (
    <footer>
      <div className={`shell ${styles.grid}`}>
        <div className={styles.brand}>
          <Link
            ...
            aria-label={
              locale === 'ro'
                ? 'Bogdan George Vizitiu — pagina principală'
                : 'Bogdan George Vizitiu — home'
            }
          >
        ...
        <div className={styles.group}>
          <p className="footer-label">
            {locale === 'ro' ? 'Lucrează cu Bogdan' : 'Work with Bogdan'}
          </p>
      ...
      <div className="shell copyright">
        © {new Date().getFullYear()} Bogdan Vizitiu{' '}
        <span>
          {locale === 'ro' ? 'Claritate înainte de soluții.' : 'Clarity before solutions.'}
        </span>
      </div>
    </footer>
  )
