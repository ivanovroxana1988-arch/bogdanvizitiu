...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Bogdan Vizitiu — Leadership, Negociere, Relații profesionale',
    template: '%s — Bogdan Vizitiu',
  },
  description:
    'Idei și experiențe practice de învățare despre leadership, negociere, networking și performanță profesională.',
  openGraph: {
    title: 'Bogdan Vizitiu',
    description: 'Leadership. Negociere. Relații care contează.',
