    ...
    <section className="shell prose">
      ...
      <div style={{margin:'48px 0'}}>
        ...
        <p><strong>{business.legalName}</strong><br/>
          ...
          {locale==='ro'?'Statut TVA':'VAT status'}: {business.vatStatus[locale]}<br/>
      ...
      <div style={{margin:'52px 0'}}>
        ...
        <p>{locale==='ro'?'Pentru întrebări privind serviciile sau acești termeni':'For questions about the services or these terms'}: <a href={`mailto:${business.email}`}>{business.email}</a> · <a href={`tel:${business.phoneHref}`}>{business.phoneDisplay}</a>.</p>
      </div>
    </section>
  </>
}
