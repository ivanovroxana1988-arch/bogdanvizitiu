    ...
    <>
      ...
      <section className="shell prose">
        ...
        <div style={{ margin: '52px 0' }}>
          ...
          <p>
            {locale === 'ro'
              ? 'Pentru orice întrebare privind datele personale sau pentru exercitarea drepturilor, scrie la'
              : 'For questions about personal data or to exercise your rights, write to'}{' '}
            <a href={`mailto:${business.email}`}>{business.email}</a>.
          </p>
          <p>
            {locale === 'ro'
              ? 'Dacă consideri că prelucrarea datelor tale încalcă legislația aplicabilă, poți depune o plângere la'
              : 'If you believe that the processing of your data breaches applicable law, you may lodge a complaint with the'}{' '}
