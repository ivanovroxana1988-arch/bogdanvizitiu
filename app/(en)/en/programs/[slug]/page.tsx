...
export function generateStaticParams(){return createParams().map(({slug})=>({slug:toEnglishProgramSlug(slug)}))}
function internalParams(params:{slug:string}){return {slug:toRomanianProgramSlug(params.slug)}}
